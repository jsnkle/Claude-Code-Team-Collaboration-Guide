...
**Current status:** Composable template structure complete with `common/` and `react/` templates. 19-part reference guide synced to Claude Code v2.1.37. Plan-specific guidance (Team Plan vs. Individual Plans) documented across onboarding, hierarchy, and security docs.
